...
urlpatterns = [
    ...
    path("projects/<int:project_id>/output-path/", views.update_output_path, name="update_output_path"),
    path("projects/<int:project_id>/artifacts/<path:relative_path>", views.serve_artifact_image, name="artifact_image"),
