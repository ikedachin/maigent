...
const translations = {
  ja: {
    ...
    threadMemoryHelp: "/compact で要約を作成すると自動でメモリが有効になり、以後の回答生成にこの要約が使われます。無効にしたい場合は /memories を実行してください。",
    noThreadMemory: "まだ要約メモリはありません。",
    skills: "スキル",
    skillsHelp: ".maigent/skills/<name>/SKILL.md を置くと、ツール選択に自動で候補として加わります。",
    noSkills: "検出されたスキルはありません。",
  ...
  en: {
    ...
    threadMemoryHelp: "Running /compact creates a summary and automatically turns memory on, so future replies use it. Run /memories to turn it off.",
    noThreadMemory: "No summary memory yet.",
    skills: "Skills",
    skillsHelp: "Drop a .maigent/skills/<name>/SKILL.md file to add it as a tool-selector candidate automatically.",
